...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.callback_url = "#{ENV['FACEBOOK_APP_DOMAIN']}/oauth/callback?provider=facebook"
  config.facebook.user_info_path = "me?fields=id,name,email"
  config.facebook.user_info_mapping = { :email => "email", :username => "name" }
  config.facebook.access_permissions = ["email","public_profile","user_friends"]
